...
export function Help() {
  ...
  return (
    <section id="contact" className="py-20 lg:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-8 lg:mb-12">
          <h2 className="tracking-tight text-lgx mb-4">Need Help?</h2>
          <p className="text-muted-foreground">
            Send us a message  or Contact us via whatsapp using the link in the contact informations section. 
          </p>
        </div>

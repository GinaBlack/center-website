    ...
    try {
      ...
      switch (newStatus) {
        case 'accepted':
          ...
          notificationMessage = `Your registration for "${program?.title}" has been accepted. Please proceed with payment to secure your spot.`;
          break;
        case 'rejected':
          notificationTitle = 'Registration Declined';
          notificationMessage = `Your registration for "${program?.title}" has been declined. ${notesInput || 'Please contact administration for more details.'}`;
          break;
        case 'enrolled':
          notificationTitle = 'Enrollment Confirmed';
          notificationMessage = `Congratulations! You are now enrolled in "${program?.title}". Welcome to the program!`;
          break;
      }
